...
open_box_btn.onclick =function()
{
  ...
  if(open_video_box_btn.className=="fa-solid fa-circle-plus")
  {
    ...
    open_video_box_btn.className="fa fa-times";


  }
  else if(open_video_box_btn.className=="fa fa-times")
  {
...
{ 
  var all_v_play_btn =document.getElementsByClassName("v_play_btn");
  var i;
  for(i=0;all_v_play_btn.length;i++);
{
...
function delete_button()
{
  ...
  for(i=0;i<all_del_btn.length; i++)
  {
    all_del_btn[i].onclick = function()
    {
      ...
      parent.className="animate__animated animate_bounceOutUp";
      setTimeout(function(){
        parent.remove();
      },1000);
    }
...
//video forword and backword coding
